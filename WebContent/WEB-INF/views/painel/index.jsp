	...
	<section class="hero cover hidden-xs" style="background-image: url(/resources/img/cover/cover-profile.jpg);">
		...
		<div class="container relative">
			<div class="page-header">
				<div class="page-title">${principal.username} <a href="/painel/editar/" class="btn btn-primary btn-sm btn-rounded" data-toggle="tooltip" title="Editar seu Perfil">Editar seu Perfil <i class="fa fa-cog"></i></a></div>
				<div class="profile-avatar">
					<div class="thumbnail" data-toggle="tooltip" title="${principal.username}">
						<a href="#">
