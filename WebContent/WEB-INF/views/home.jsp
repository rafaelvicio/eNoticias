    ...
    <div class="pushy-panel__inner">
        <header class="pushy-panel__header">
            <div class="pushy-panel__logo">
                <a href="index.html"><img src="/resources/assets/images/soccer/logo-pushy.png" alt="Alchemists"></a>
            </div>
        </header>
                    ...
                    <ul class="posts posts--simple-list">
                        <li class="posts__item posts__item--category-1">
                            <figure class="posts__thumb">
                                <a href="#"><img src="/resources/assets/images/samples/post-img19-xs.jpg" alt=""></a>
                            </figure>
            ...
            <aside class="widget widget--side-panel widget-banner">
                <div class="widget__content">
                    <figure class="widget-banner__img">
                        <a href="#"><img src="/resources/assets/images/samples/banner.jpg" alt="Banner"></a>
                    </figure>
                </div>
            </aside>
            <!-- Widget: Banner / End -->
            ...
            <div class="content col-md-8">
                ...
                <div class="card card--clean">
                    <header class="card__header card__header--has-filter">
                        ...
                        <a href="#" class="btn btn-default btn-outline btn-xs card-header__button">Ver todas</a>
                    </header>
                ...
                <div class="main-news-banner main-news-banner--soccer-ball">
                    <div class="main-news-banner__inner">
                        <div class="posts posts--simple-list posts--simple-list--xlg">
                            <div class="posts__item posts__item--category-1">
                                <div class="posts__inner">
                                    <h6 class="posts__title"><a href="#">Conheça a <span class="main-news-banner__highlight">ESC</span> sua plataforma de eSports</a></h6>
                                    <div class="posts__excerpt">
                                        A eSports Club e uma plataforma de competições de eSports. Participe de competições diarias e entre no mundo do eSports!
                                    </div>
                                    <div class="posts__more">
                                        <a href="#" class="btn btn-inverse btn-sm btn-outline btn-icon-right btn-condensed">Conheça mais <i class="fa fa-plus text-primary"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div id="sidebar" class="sidebar col-md-4">
                            ...
                            <table class="table table-hover table-standings">
                                    ...
                                    <td>
                                        <div class="team-meta">
                                            <figure class="team-meta__logo">
                                                <img src="/resources/assets/images/samples/logos/logo_cnb.png" alt="">
                                            </figure>
                                            <div class="team-meta__info">
                                                <h6 class="team-meta__name">CNB e-Sports Club</h6>
                                                <span class="team-meta__place">League of Legends</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>36</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="team-meta">
                                            <figure class="team-meta__logo">
                                                <img src="/resources/assets/images/samples/logos/logo_sk.png" alt="">
                                            </figure>
                                            <div class="team-meta__info">
                                                <h6 class="team-meta__name">SK Gaming</h6>
                                                <span class="team-meta__place">Counter-Strike: GO</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>32</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="team-meta">
                                            <figure class="team-meta__logo">
                                                <img src="/resources/assets/images/samples/logos/logo_immortals.png" alt="">
                                            </figure>
                                            <div class="team-meta__info">
                                                <h6 class="team-meta__name">Immortals</h6>
                                                <span class="team-meta__place">Counter-Strike: GO</span>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="team-meta">
                                            <figure class="team-meta__logo">
                                                <img src="/resources/assets/images/samples/logos/logo_pain.png" alt="">
                                            </figure>
                                            <div class="team-meta__info">
                                                <h6 class="team-meta__name">paiN Gaming</h6>
                                                <span class="team-meta__place">League of Legends</span>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="team-meta">
                                            <figure class="team-meta__logo">
                                                <img src="/resources/assets/images/samples/logos/logo_keyd.png" alt="">
                                            </figure>
                                            <div class="team-meta__info">
                                                <h6 class="team-meta__name">Keyd Stars</h6>
                                                <span class="team-meta__place">League of Legends</span>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="team-meta">
                                            <figure class="team-meta__logo">
                                                <img src="/resources/assets/images/samples/logos/logo_redcanids.png" alt="">
                                            </figure>
                                            <div class="team-meta__info">
                                                <h6 class="team-meta__name">RED Canids</h6>
                                                <span class="team-meta__place">League of Legends</span>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="team-meta">
                                            <figure class="team-meta__logo">
                                                <img src="/resources/assets/images/samples/logos/draconians_shield.png" alt="">
                                            </figure>
                                            <div class="team-meta__info">
                                ...
                                <tr>
                                    <td>
                                        <div class="team-meta">
                                            <figure class="team-meta__logo">
                                                <img src="/resources/assets/images/samples/logos/bloody_wave_shield.png" alt="">
                                            </figure>
                                            <div class="team-meta__info">
                ...
                <aside class="widget widget--sidebar widget-social widget-social--condensed">
                    ...
                    <a href="#" class="btn-social-counter btn-social-counter--twitter">
                        ...
                        <h6 class="btn-social-counter__title">Siga no Facebook</h6>
                        ...
                        <ul class="posts posts--simple-list">
                            ...
                            <c:if test="${!empty noticias}">
                                <c:forEach items="${noticias}" var="noticia">
                                    ...
                                    <li class="posts__item posts__item--category-1">
                                        <figure class="posts__thumb">
                                            <a href="#"><img src="/resources/assets/images/samples/post-img2-xs.jpg" alt=""></a>
                                        </figure>
                                        <div class="posts__inner">
                                            <div class="posts__cat">
                                                <span class="label posts__cat-label">${noticia.jogo.nome}</span>
                                            ...
                                            <time datetime="2016-08-22" class="posts__date">${noticia.data}</time>
                                        </div>
                                    </li>
                    ...
                    <div class="widget__content card__content">
                        ...
                        <div class="match-preview">
                                ...
                                <div class="match-preview__content">
                                    ...
                                    <div class="match-preview__team match-preview__team--first">
                                        <figure class="match-preview__team-logo">
                                            <img src="/resources/assets/images/soccer/logos/alchemists_buy_tickets.png" alt="">
                                        </figure>
                                    ...
                                    <div class="match-preview__team match-preview__team--second">
                                        <figure class="match-preview__team-logo">
                                            <img src="/resources/assets/images/soccer/logos/pirates_buy_tickets.png" alt="">
                                        </figure>
                            ...
                            <div class="countdown__content">
                                <div class="countdown-counter" data-date="December 31, 2016 12:00:00"></div>
                            </div>
