            ...
            <div class="col-md-8">
                ...
                <div class="card card--lg">
                    <header class="card__header card__header--has-btn">
                        <h4>Todas as Tags</h4>
                        <a href="/administracao/tags/cadastro" class="btn btn-default btn-outline btn-xs card-header__button">Cadastrar Tag</a>
                    </header>
                    <div class="card__content">
                            ...
                            <table class="table">
                                ...
                                <c:if test="${!empty tags}">
                                    <c:forEach items="${tags}" var="tag">
                                        ...
                                        <tr>
                                            <td>${tag.nome}</td>
                                            <td><a href="/administracao/tags/alterar/${tag.id}" class="btn btn-xs btn-default btn-outline btn-block">Alterar</a></td>
                                            <td><a href="/administracao/tags/excluir/${tag.id}" class="btn btn-xs btn-default btn-outline btn-block">Excluir</a></td>
                                        </tr>
