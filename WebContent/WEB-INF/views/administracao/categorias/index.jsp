            ...
            <div class="col-md-8">
                ...
                <div class="card card--lg">
                    <header class="card__header card__header--has-btn">
                        ...
                        <a href="/administracao/categorias/cadastro" class="btn btn-default btn-outline btn-xs card-header__button">Cadastrar Categoria</a>
                    </header>
                    <div class="card__content">
                                ...
                                <c:if test="${!empty categorias}">
                                    <c:forEach items="${categorias}" var="categoria">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="/administracao/categorias/alterar/${categoria.id}" class="btn btn-xs btn-default btn-outline btn-block">Alterar</a></td>
                                            <td><a href="/administracao/categorias/excluir/${categoria.id}" class="btn btn-xs btn-default btn-outline btn-block">Excluir</a></td>
                                        </tr>
