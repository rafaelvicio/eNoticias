...
<c:url var="actionAlterar" value="/administracao/jogos/alterar"></c:url>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="card card--lg">
                    ...
                    <div class="card__content">
                        <form:form action="${actionAlterar}" method="post" modelAttribute="jogo" cssClass="df-personal-info">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group--submit">
                                <input type="submit" value="Alterar Jogo" class="btn btn-default btn-lg btn-block" />
                            </div>
